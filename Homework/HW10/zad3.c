...
//dobavil sum edin unsigned za da moje da proverim konkreten index v masiva tui kato ne mi stana qsno
//ot uslovieto tochno za koi element trqbva da proverim bita
